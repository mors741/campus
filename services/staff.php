...
<div class="container">
    ...
    <div class="span3">
        ...
        <table id="grid-basic" class="table table-hover table-responsive table-bordered" width="100%">
            <thead>
            <th rowspan="3" data-column-id="post"><strong>Должность</strong></th>
            <th rowspan="3" data-column-id="performer"><strong>ФИО</strong></th>
            <th rowspan="3" data-column-id="rating"><strong>Рейтинг</strong></th>
            </thead>
        </table>
    </div>
</div>
...
<script src="../js/services/staff.js"></script>
